...
export default function OfferElement(props: OfferElementProps) {
    ...
    return (
        <div className={`offer-element bg-white ${window.innerWidth > 1000 ? 'grid' : 'flex'} ${window.innerWidth > 1000 ? 'grid-cols-3' : ''} border p-4 rounded-md mb-4 transition duration-300 hover:shadow-md `}>
                ...
                <div className="offer-element-details col-span-2 mt-4">
                    ...
                    {props.auctionEnd ? (
                        <div className="offer-element-details-bid">
                            ...
                            <p className="text-gray-700">Last Bid: <span className="font-bold">{price}</span>  by {lastBidder}</p>
